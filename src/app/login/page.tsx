...
.lp-toggle{position:absolute;right:14px;top:50%;transform:translateY(-50%);color:#82889A;background:none;border:none;cursor:pointer;padding:3px;display:flex}
.lp-toggle:hover{color:#A8ADB8}
